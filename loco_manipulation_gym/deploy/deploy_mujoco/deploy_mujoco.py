    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while viewer.is_running() and time.time() - start < simulation_duration:
            ...
            if counter % control_decimation == 0:
                ...
                # create observation
                base_lin_vel = d.qvel[0:3] * lin_vel_scale
                base_ang_vel = d.qvel[3:6] * ang_vel_scale
                quat = d.qpos[3:7]
                gravity_orientation = get_gravity_orientation(quat)
                dof_pos = d.qpos[7:]
                dof_err = (dof_pos - default_angles) * dof_pos_scale
                wheel_indices = [0, 3]
                dof_err[wheel_indices] = 0.0
                dof_vel = d.qvel[6:] * dof_vel_scale
                ...
                obs[12 : 12 + num_actions] = dof_err
                obs[12 + num_actions : 12 + 2 * num_actions] = dof_vel
